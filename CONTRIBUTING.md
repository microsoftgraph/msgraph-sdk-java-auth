# Contributing to the Microsoft Graph Auth SDK for Java

The Microsoft Graph Auth SDK for Java is available for all manner of contribution. There are a couple of different recommended paths to get contributions into the released version of this SDK.
...
This project follows the [all contributors](https://github.com/kentcdodds/all-contributors) specification. When making a contribution, please add yourself to the table of contributors:
 ...
 1. In section 5. of the [README.md](https://github.com/microsoftgraph/msgraph-sdk-java-auth/blob/dev/readme.md), after the last "|", copy and paste a new blank contributor element
    ```html
